                                    ...
                                    channel?.username === user.username ?
                                        ...
                                        <button
                                            ...
                                            <span class="inline-block w-5">
                                                ...
                                                <img src={subscribingChannel ? "../public/Logo/loading.svg" : "../public/Logo/subscribe.svg"} alt="" />
                                            </span>
                                            <span onClick={() => handleSubscriptionOfChannel()}>{channel?.isSubscribedTo ? "Subscribed" : "Subscribe"}</span>
                                        </button>
                                }
                            </div>
                        </div>
